...
export class DateUtils {
    ...
    static toShortDaysOfWeekArray(shortDayList: string) : ShortDaysOfWeek[] {
        ...
        if(shortDayList === "" || shortDayList.convertToProperCase() === ShortDaysOfWeekCompositeKeys.None)
        {
            return [];
        }
        ...
        {
            return [ ShortDaysOfWeek.Mon, ShortDaysOfWeek.Tue, ShortDaysOfWeek.Wed,
                    ShortDaysOfWeek.Thu, ShortDaysOfWeek.Fri, ShortDaysOfWeek.Sat,
                    ShortDaysOfWeek.Sun ];
        }
