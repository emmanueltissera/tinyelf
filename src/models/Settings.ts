...
export class Settings {
  ...
  constructor() {
    ...
    this.checkEventExists = SpreadsheetService.getCellValueByName(SettingsKeys.CheckEventExists)
      .toString()
      .toBoolean();
    this.rosterCheck = EnumUtils.toRosterCheck(
      SpreadsheetService.getCellValueByName(SettingsKeys.RosterCheck)
    );
    ...
    this.messageBusySummary = SpreadsheetService.getCellValueByName(
      SettingsKeys.SlackMessageBusySummary
    );
    ...
    this.triggerOnDays = DateUtils.toShortDaysOfWeekArray(
      SpreadsheetService.getCellValueByName(SettingsKeys.TriggerOnDays).toString()
    );
  }
